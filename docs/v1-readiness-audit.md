...
| Lembretes/notificações | Falta | v1 importante | `Reminder` em `prisma/schema.prisma`, `NotificationButton` | Não há CRUD de reminder, cron, email de renovação, push ou contagem real no header. |
