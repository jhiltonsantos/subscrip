  ...
  return (
    <header className="border-b border-gray-200/50 dark:border-gray-800/50 bg-background/50 py-2">
      <div className="w-full max-w-5xl mx-auto px-6 py-3">
        <div className="flex items-center justify-between gap-4 px-6 py-3 bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-full border border-gray-200/80 dark:border-gray-800/80 shadow-sm">
