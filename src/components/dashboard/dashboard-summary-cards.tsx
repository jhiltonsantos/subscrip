...
export function DashboardSummaryCards(props: DashboardSummaryCardsProps) {
  ...
  return (
    <div
      ...
      className="flex gap-3 overflow-x-auto pb-1 snap-x snap-mandatory [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:grid lg:grid-cols-2 lg:gap-4 lg:overflow-visible lg:pb-0 lg:snap-none xl:grid-cols-5"
    >
